...
function SeoFlightRoutesSection() {
  const flightRoutes = {
    ...
    "Châu Âu": [
      ...
      { name: "Khách sạn London", url: "/khach-san-london" },
      { name: "Khách sạn Rome", url: "/khach-san-rome" },
      { name: "Khách sạn Barcelona", url: "/khach-san-barcelona" },
      { name: "Khách sạn Amsterdam", url: "/khach-san-amsterdam" },
      { name: "Khách sạn Berlin", url: "/khach-san-berlin" },
      { name: "Khách sạn Madrid", url: "/khach-san-madrid" },
      { name: "Khách sạn Vienna", url: "/khach-san-vienna" },
      { name: "Khách sạn Prague", url: "/khach-san-prague" },
      { name: "Khách sạn Budapest", url: "/khach-san-budapest" },
      { name: "Khách sạn Munich", url: "/khach-san-munich" },
      { name: "Khách sạn Frankfurt", url: "/khach-san-frankfurt" },
      { name: "Khách sạn Zurich", url: "/khach-san-zurich" },
      { name: "Khách sạn Milan", url: "/khach-san-milan" },
      { name: "Khách sạn Venice", url: "/khach-san-venice" },
      { name: "Khách sạn Florence", url: "/khach-san-florence" },
      { name: "Khách sạn Athens", url: "/khach-san-athens" },
      { name: "Khách sạn Stockholm", url: "/khach-san-stockholm" },
      { name: "Khách sạn Copenhagen", url: "/khach-san-copenhagen" },
