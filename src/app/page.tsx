...
function WhyChooseSkyoSection() {
  const reasons = [
    ...
    },
    {
      ...
      stats: 'Response < 5 phút'
    },
    {
      icon: Globe,
      title: 'Toàn Cầu',
      description: '2M+ khách sạn và 1000+ hãng bay trên toàn thế giới',
    ...
    },
    {
      icon: Award,
      title: 'Chất Lượng',
      description: 'Giải thưởng "Best Travel Platform 2024" từ Travel Excellence Awards',
      color: 'from-red-500 to-rose-600',
      stats: 'Top 1 Việt Nam'
    }
  ]
...
function TrustNumbersSection() {
  const numbers = [
    ...
    { number: '50K+', label: 'Chuyến bay mỗi tháng', icon: Plane, color: 'text-green-600' },
    { number: '1M+', label: 'Đêm khách sạn đã đặt', icon: Hotel, color: 'text-purple-600' },
    { number: '200+', label: 'Quốc gia & vùng lãnh thổ', icon: Globe, color: 'text-orange-600' },
    { number: '99.9%', label: 'Tỷ lệ đặt chỗ thành công', icon: CheckCircle, color: 'text-emerald-600' },
    { number: '24/7', label: 'Hỗ trợ khách hàng', icon: Headphones, color: 'text-red-600' }
  ]

  const partners = [
    'Vietnam Airlines', 'Vietjet Air', 'Jetstar Pacific', 'Bamboo Airways',
    'Vinpearl Hotels', 'Muong Thanh', 'FLC Hotels', 'Saigon Tourist'
  ]
      ...
      <div className="container mx-auto px-4">
        ...
        <div className="bg-gradient-to-r from-green-50 to-blue-50 rounded-2xl p-8 border border-green-200">
          <div className="text-center mb-8">
            <h3 className="text-2xl font-bold text-gray-800 mb-4">Đối tác tin cậy</h3>
            <p className="text-gray-600">Hợp tác chính thức với các thương hiệu hàng đầu</p>
          </div>
          <div className="grid grid-cols-2 md:grid-cols-4 gap-6 items-center">
            {partners.map((partner, index) => (
              <div key={index} className="text-center p-4 bg-white rounded-lg shadow-sm hover:shadow-md transition-shadow">
                <div className="text-gray-700 font-semibold text-sm">{partner}</div>
              </div>
            ))}
          </div>
        </div>
  ...
  const testimonials = [
    {
      ...
      rating: 5,
      comment: 'Đặt vé qua Skyo siêu nhanh và giá rẻ hơn các trang khác rất nhiều. Tôi đã tiết kiệm được 2 triệu cho chuyến du lịch gia đình.',
      trip: 'HCM → Tokyo',
      saved: '2.3M VND'
    },
    {
      ...
      rating: 5,
      comment: 'Hỗ trợ khách hàng tuyệt vời! Khi có vấn đề với chuyến bay, team Skyo đã giúp tôi đổi vé miễn phí trong vòng 10 phút.',
      trip: 'HN → Singapore',
      saved: '1.8M VND'
    },
    {
    ...
    },
    {
      ...
      rating: 5,
      comment: 'App Skyo rất tiện lợi, interface đẹp và search nhanh. Đặt vé công tác hàng tháng chưa bao giờ gặp vấn đề gì.',
      trip: 'HCM → HN',
      saved: '800K VND'
    }
  ]
              ...
              <CardContent className="p-6">
                ...
                <div className="space-y-2">
                  ...
                  <div className="flex justify-between text-sm">
                    ...
                    <span className="text-green-300 font-bold">{testimonial.saved}</span>
                  </div>
                </div>
              </CardContent>
            </Card>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
          <div className="text-white">
            ...
            <p className="text-xl text-white/90 mb-8 leading-relaxed">
              Tải app Skyo để trải nghiệm đặt vé nhanh chóng, nhận thông báo giá rẻ và quản lý chuyến đi một cách dễ dàng.
            </p>
            ...
            <div className="grid grid-cols-2 gap-6 mb-8">
              ...
              <div className="flex items-center gap-3">
                ...
                <div>
                  <div className="font-semibold">Check-in online</div>
                  <div className="text-sm text-white/70">Tiết kiệm thời gian</div>
                </div>
              </div>
              <div className="flex items-center gap-3">
                <div className="w-12 h-12 bg-white/20 rounded-full flex items-center justify-center">
                ...
                <div>
                  ...
                  <div className="text-sm text-white/70">Bảo mật cao</div>
                </div>
              </div>
            </div>

            <div className="flex flex-wrap gap-4">
              <Button size="lg" className="bg-white text-gray-900 hover:bg-gray-100 font-semibold px-6">
          ...
          <div className="relative">
            ...
            <div className="absolute top-8 right-8 bg-white p-4 rounded-xl shadow-lg">
              ...
              <p className="text-xs text-gray-600 mt-2 text-center">Scan để tải app</p>
            </div>
          </div>
        </div>
      </div>
  ...
  return (
    <div className="min-h-screen">
      ...
      <div
        ...
        style={{
          backgroundImage: "linear-gradient(135deg, rgba(34, 197, 94, 0.1) 0%, rgba(59, 130, 246, 0.1) 100%), url('https://images.unsplash.com/photo-1544735716-392fe2489ffa?ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D&auto=format&fit=crop&w=2070&q=80')"
        }}
      >
        {/* Animated Overlay */}
        <div className="absolute inset-0 bg-gradient-to-br from-blue-900/30 via-green-900/20 to-blue-800/40" />
        ...
        <div className="relative z-10 container mx-auto px-4 pt-12 pb-8">
          ...
          <div className="text-center mb-12">
            <h1 className="text-5xl md:text-6xl font-bold text-white mb-6 leading-tight">
              Khám phá <span className="text-green-400">thế giới</span>
              <br />
              với giá tốt nhất
            </h1>
            <p className="text-xl md:text-2xl text-white/90 mb-8 max-w-3xl mx-auto leading-relaxed">
              Tìm kiếm và đặt vé máy bay & khách sạn toàn cầu với hơn 1000+ chuyến bay và 2M+ khách sạn mỗi ngày
            </p>
          </div>
